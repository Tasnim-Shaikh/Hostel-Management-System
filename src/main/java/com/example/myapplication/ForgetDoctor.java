...
public class ForgetDoctor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        helper = new DatabaseHelper2(ForgetDoctor.this);
                ...
                if (username.isEmpty() || password.isEmpty() || confirm.isEmpty()) {
                    ...
                    helper.updateUserPassword(username, password, confirm, new DatabaseHelper.OnResultListener<String>() {
                        ...
                        public void onSuccess(String result) {
                            Toast.makeText(ForgetDoctor.this, result, Toast.LENGTH_SHORT).show();
                        }

                        @Override
                        public void onFailure(Exception e) {
                            Toast.makeText(ForgetDoctor.this, "Error: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    });
                }
